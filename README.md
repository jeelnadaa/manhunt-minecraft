...
- **Interactive GUI & CLI Controls**: Manage the entire match, add/remove runners, toggle chat logs, generate worlds, and configure time limits via an intuitive chest GUI (`/manhunt gui`) or CLI with instant disk synchronization (`config.yml`).
